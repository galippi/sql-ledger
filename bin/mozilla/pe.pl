...
";
  ...
  $i = 1;
  if ($myconfig{acs} !~ /System--Projects--Add Project/) {
...
<table width=100%>
  ...
  <tr>
	...
	<tr>
	  ...
	  <td><input name=projectnumber class="required" size=20 value="$form->{projectnumber}"></td>
	</tr>
	<tr>
	  <th align=right>|.$locale->text('Description').qq|</th>
	  <td>$description</td>
...
";
  ...
  $i = 1;
  if ($myconfig{acs} !~ /Goods--Groups--Add Group/) {
    $button{'Goods--Add Group'}{code} = qq|<input class=submit type=submit name=action value="|.$locale->text('Add Group').qq|"> |;
    $button{'Goods--Add Group'}{order} = $i++;
  ...
  <tr>
	...
	<tr>
	  <th align=right>|.$locale->text('Group').qq|</th>
          ...
          <td><input name=partsgroup class="required" size=30 value="$form->{partsgroup}"></td>
	</tr>
      </table>
    </td>
  </tr>
...
";
  ...
  $i = 1;
  if ($myconfig{acs} !~ /System--Pricegroups--Add Pricegroup/) {
    $button{'Goods--Add Pricegroup'}{code} = qq|<input class=submit type=submit name=action value="|.$locale->text('Add Pricegroup').qq|"> |;
    $button{'Goods--Add Pricegroup'}{order} = $i++;
  ...
  <tr>
	...
	<tr>
	  <th align=right>|.$locale->text('Pricegroup').qq|</th>
          ...
          <td><input name=pricegroup class="required" size=30 value="$form->{pricegroup}"></td>
	</tr>
      </table>
    </td>
  </tr>
