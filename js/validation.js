...
Validation.addAllThese([
	['required', 'A mezõ kitöltése szükséges.', function(v) {
	...
	['validate-szam', 'Jó számformátum szükséges, pl. 245,34', function(v) {
				// [$]1[##][,###]+[.##]
				// [$]1###+[.##]
				// [$]0.##
				// [$].##
				return Validation.get('IsEmpty').test(v) ||  /^[\-\+]?([0-9]{1}[0-9]{0,}(\.[0-9]{3})*(\,[0-9]{0,})?|[1-9]{1}\d*(\,[0-9]{0,})?|0(\,[0-9]{0,})?|(\,[0-9]{1,})?)$/.test(v)
			}],
