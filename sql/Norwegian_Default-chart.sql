...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1100', 'Bygninger', 'A','', 'A', 'AR_paid');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1120', 'Bygningsmessige anlegg', 'A','', 'A', 'AR_paid');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1200', 'Maskiner og anlegg', 'A','', 'A', 'AR_paid');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1210', 'Maskiner og anlegg under utførelse', 'A','', 'A', 'AR_paid');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1270', 'Verktøy mv.', 'A','', 'A', 'IC');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1280', 'Kontormaskiner', 'A','', 'A', 'AR');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('191', 'Bankinnskudd, kontanter o.l.', 'H', '', 'A', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1910', 'Kasse', 'A','', 'A', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1930', 'Bankinnskudd', 'A','', 'A', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1940', 'Bankinnskudd for skattetrekk', 'A','', 'A', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1970', 'Postgiro', 'A','', 'A', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2410', 'Leverandørgjeld', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2500', 'Betalbar skatt, ikke utlignet', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2510', 'Betalbar skatt, utlignet', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2610', 'Skattetrekk', 'A','', 'L', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2710', 'Utgående 24% mva', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2715', 'Utgående 12% mva', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2717', 'Beregnet avgift utlandet', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2720', 'Inngående 24% mva', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2725', 'Inngående 12% mva', 'A','', 'L', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('301', 'Resultat før ekstraorinære inntekter og kostnader', 'H', '', 'I', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3010', 'Salgsinntekter, 24% mva', 'A','', 'I', 'AP_tax');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3019', 'Frakt', 'A','', 'I', 'AP_tax');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3020', 'Salgsinntekter, 12% mva', 'A','', 'I', 'AP_tax');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3060', 'Uttak av varer', 'A','', 'I', 'AP_tax');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3080', 'Rabatter og andre salgsinntektsreduksjon', 'A','', 'I', 'AP_tax');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3099', 'Miljøavgift', 'A','', 'I', 'AP_tax');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3110', 'Salgsinntekter, avgiftsfrie', 'A','', 'I', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3500', 'Garanti og service', 'A','', 'I', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6100', 'Frakter, transportkostnader og forsikring', 'A','', 'E', 'IC_expense');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6110', 'Toll og spedisjonskostnader ved forsend', 'A','', 'E', 'IC_expense');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6260', 'Vann', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6300', 'Leie lokaler', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6320', 'Renovasjon, vann, avløp mv.', 'A','', 'E', 'IC_expense');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6340', 'Lys, varme', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6560', 'Rekvisita', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6570', 'Arbeidsklær og verneutstyr', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6800', 'Kontorrekvisita', 'A','', 'E', '');
...
--
update defaults set inventory_accno_id = (select id from chart where accno = '4010'), income_accno_id = (select id from chart where accno = '3010'), expense_accno_id = (select id from chart where accno = '6560'), fxgain_accno_id = (select id from chart where accno = '8080'), fxloss_accno_id = (select id from chart where accno = '8180'), invnumber = '1000', sonumber = '1000', ponumber = '1000', curr = 'NOK:EUR:USD', weightunit = 'kg';
--
