...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1825','累计分期付款 - 装璜及设备.','A','','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1845','累计分期付款 - 运输工具','A','','A','');
