...
UPDATE defaults SET inventory_accno_id = (SELECT id FROM chart WHERE accno = '340'), income_accno_id = (SELECT id FROM chart WHERE accno = '499000'), expense_accno_id = (SELECT id FROM chart WHERE accno = '499000'), fxgain_accno_id = (SELECT id FROM chart WHERE accno = '755000'), fxloss_accno_id = (SELECT id FROM chart WHERE accno = '655000'), yearend = '12/31', weightunit = 'kg', curr = 'EUR:USD';
