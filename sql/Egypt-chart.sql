...
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno) VALUES ('1845','مخصص اهلاك سيارات','A','A','','');
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno) VALUES ('1820','اثاث مكتبى و معدات','A','A','','');
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno) VALUES ('1825','مخصص اهلاك اثاث مكتبى و معدات','A','A','','');
...
UPDATE defaults SET inventory_accno_id = (SELECT id FROM chart WHERE accno = '1520'), income_accno_id = (SELECT id FROM chart WHERE accno = '4020'), expense_accno_id = (SELECT id FROM chart WHERE accno = '5010'), fxgain_accno_id = (SELECT id FROM chart WHERE accno = '4450'), fxloss_accno_id = (SELECT id FROM chart WHERE accno = '5810'), invnumber = '0', sonumber = '0', weightunit = 'kg', curr = 'USD:CAD:EUR', revtrans = '0', ponumber = '0', sqnumber = '0', rfqnumber = '0', audittrail = '0';
