...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1825','累計分期付款 - 裝璜及設備.','A','','A','');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1845','累計分期付款 - 運輸工具','A','','A','');
